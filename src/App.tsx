...
export default function App() {
  ...
  // NOVO: Estado para aba de categoria ativa
  ...
  // Listener para times verificados (público)
  useEffect(() => {
  ...
  // Listener para times pendentes (admin ou owner)
  useEffect(() => {
    if (!user || (!user.emailVerified && !user.isAnonymous)) {
      setTeams(prev => prev.filter(t => t.isVerified));
      return;
    }
    ...
    return () => { unsubscribeOwnedOrAdmin(); };
  }, [user]);
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center relative z-10">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                {/* ALTERADO: Coach Rafael Cobra → Comissão Técnica */}
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              {user.photoURL && (
                <img src={user.photoURL} alt="Avatar" className="w-10 h-10 rounded-full border-2 border-orange-400 shadow-md object-cover flex-shrink-0" referrerPolicy="no-referrer" />
              )}
        ...
        {!user ? (
          <div className="text-center py-24 px-4 bg-stone-900 rounded-[32px] shadow-2xl border border-stone-200/20 mt-10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="relative flex flex-col items-center mb-6">
                <div className="flex items-end justify-center mb-1" style={{ width: '130px', height: '36px' }}>
                  <svg viewBox="0 0 180 50" className="w-full h-full overflow-visible">
                    ...
                    <text fill="#22c55e" fontSize="24" fontWeight="bold" letterSpacing="2">
                      <textPath href="#curve-hero" startOffset="50%" textAnchor="middle">★★★★★★★</textPath>
                    </text>
                  </svg>
                </div>
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight drop-shadow-md text-center">
                BANCO DE DADOS, BASE E PROFISSIONAL
              </h2>
              ...
              <div className="print:block">
                ...
                {filteredTeams.length === 0 ? (
                  <div className="bg-white text-center p-16 rounded-[32px] border border-stone-200 shadow-sm">
                    ...
                    <p className="text-stone-400 mt-2">Ajuste os filtros, a aba selecionada ou crie uma nova ficha.</p>
                  </div>
                ) : viewMode === 'cards' ? (
                      ...
                      <div key={t.id} onClick={() => setSelectedPlayer(t)}
                        ...
                        <div className="px-5 pb-5 flex-1 flex flex-col">
                          ...
                          <div className="mt-auto space-y-2 pt-2 border-t border-stone-100">
                            ...
                            {!t.isVerified && t.ownerId === user?.uid && !isAdmin && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/80 backdrop-blur-sm shadow-2xl transition-opacity animate-in fade-in duration-300 print:absolute print:inset-0 print:bg-white print:p-0">
          <div className="bg-white rounded-[32px] w-full max-w-3xl max-h-[90vh] overflow-y-auto overflow-x-hidden flex flex-col relative animate-in zoom-in-95 duration-300 print:max-h-none print:overflow-visible print:rounded-none">
            ...
            <div className="p-6 md:p-8">
              ...
              {(selectedPlayer.ownerId === user?.uid || (!selectedPlayer.isVerified && isAdmin)) && (
                <div className="mt-8 flex justify-end gap-3 border-t border-stone-100 pt-6 print:hidden">
                  {!selectedPlayer.isVerified && isAdmin && (
                    <button onClick={() => { handleApprove(selectedPlayer.id); setSelectedPlayer(null); }}
